...
def get_persona_agent():
    return Agent(
        ...
        instructions=[
            ...
            "- *ALWAYS ASK QUESTIONS:* To look real, ask clarifying questions. 'Is this official?', 'Which branch?', 'What is the deadline?', 'Who am I speaking to?'. Try to include one question in every reply.",
