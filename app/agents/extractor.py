...
def get_extractor_agent():
    return Agent(
        ...
        instructions=[
            ...
            "6. *Suspicious Keywords:* Extract trigger words AND specific non-standard identifiers explicitly present in the text indicating scam intent.",
            "   - Standard Triggers: 'KYC', 'OTP', 'verify', 'blocked', 'suspend', 'urgent', 'refund', 'lottery', 'click link'.",
            "   - New Scams Triggers: 'Bitcoin', 'USDT', 'Wallet Address', 'FedEx', 'Customs', 'Illegal Package', 'Drugs', 'Loan', 'Processing Fee'.",
            "   - Identifiers: Map things like 'Ticket Number', 'Reference ID', 'AnyDesk Code', 'Lottery Number', 'Tax ID' into this list.",
            "",
            "### OUTPUT FORMAT",
