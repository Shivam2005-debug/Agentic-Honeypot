...
def get_extractor_agent():
    return Agent(
        ...
        instructions=[
            ...
            "7. **Policy/Order Numbers:** Extract insurance policy numbers or shopping order IDs (e.g., 'POL-999', 'ORD-456').",
            "8. **Suspicious Keywords:** Extract trigger words explicitly present in the text indicating scam intent.",
            ...
            '{ "bankAccounts": [], "upiIds": [], "phishingLinks": [], "phoneNumbers": [], "emailAddresses": [], "caseIds": [], "policyNumbers": [], "orderNumbers": [], "suspiciousKeywords": [] }',
