...
def get_detector_agent():
    return Agent(
        ...
        instructions=[
            ...
            "Task 3: Determine 'scam_type' (string). Choose closest: 'bank_fraud', 'upi_fraud', 'phishing', 'job_scam', 'lottery_scam', 'tech_support', 'courier_scam', 'govt_scheme'.",
            "Task 4: Determine 'confidence' (float) between 0.0 and 1.0.",
            "Return JSON strictly: {\"is_scam\": boolean, \"confidence\": float, \"reasoning\": \"string\", \"behavior_summary\": \"string\", \"scam_type\": \"string\"}",
